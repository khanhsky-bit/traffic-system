...
class _ViewerHomeState extends State<ViewerHome> {
  ...
  Future<void> fetchLanesData() async {
    if (isLoading) return; // Tránh gọi nhiều request cùng lúc
    ...
    try {
      ...
      // Thêm headers để force refresh, không dùng cache
  ...
  Widget build(BuildContext context) {
    ...
    // Feature được bật - hiển thị nội dung
    return Scaffold(
      appBar: AppBar(
        title: Text('Vehicle Monitoring'),
        backgroundColor: Colors.blue.shade700,
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 8),
                            Text(
                              '💡 Giải pháp 1 (Khuyến nghị): Thêm CORS vào Flask server',
